...
def main():
    ...
    parser.add_argument(
        "--config_file", default="D:/PyCharmPro/Code/MAFFN/configs/AGW_baseline.yml",
    ...
    if cfg.MODEL.PRETRAIN_CHOICE == 'self':
        ...
        optimizer['model'] = torch.load(path_to_optimizer)
        optimizer['center'] = torch.load(path_to_optimizer_center)
        criterion['center'] = torch.load(path_to_center_param)
